...
@Component({
  ...
  providers: [SignupService, CountriesService]
})
export class SignupComponent {
  ...
  checkPassStrength(inputPass: any ): any {
  ...
  onChangeCountry(inputCountry:any) {
    //console.log(inputCountry.value);
    //console.log(this.countryInfo[inputCountry.value]);

    this.provinceInfo = this.countryInfo[inputCountry.value].States;
    this.cityInfo = this.provinceInfo[0].Cities;
  }

  onChangeProvince(inputProvince:any) {
    if (this.provinceInfo && inputProvince != null && inputProvince !== undefined) {
      this.cityInfo = this.provinceInfo[inputProvince.value].Cities;
    }
  }
